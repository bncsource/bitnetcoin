...
#define REWARD_CUT_BLOCK 18000000
...
const string strMessageMagic = "bitnetcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bitnetcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Brazil Requires Crypto Exchanges to Report on User Transactions to Authorities";
        CTransaction txNew;
        txNew.nTime = 1561035673;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1561035673;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3440200;

        if (fTestNet)
        {
            block.nTime    = 1561035681;
            block.nNonce   = 385477036;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb5ff3d31c4806c672ceb17162959fd92f46171b0204247841f1536db450331d7"));
...
unsigned char pchMessageStart[4] = { 0x42, 0x49, 0x4e, 0x43 };
